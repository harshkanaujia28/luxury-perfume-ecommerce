      ...
      <main>
        ...
        <section className="luxury-gradient py-48">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="text-4xl lg:text-5xl font-bold text-lime-400 mb-6">Returns & Exchanges</h1>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="mb-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                {returnSteps.map((step) => {
                  ...
                  return (
                    <Card key={step.step} className="text-center bg-neutral-900 border border-neutral-800">
                      <CardContent className="p-6">
                        <div className="w-12 h-12 bg-lime-400 rounded-full flex items-center justify-center mx-auto mb-4">
                          <Icon className="w-6 h-6 text-black" />
                        </div>
                        <div className="text-sm font-medium text-gray-400 mb-2">Step {step.step}</div>
                    ...
                    {returnableItems.map((item) => {
                      ...
                      return (
                        <div key={item.item} className="flex items-center space-x-3">
                          <Icon
                            className={`w-5 h-5 ${
                              item.status === "returnable" ? "text-lime-400" : "text-red-500"
                            }`}
                          />
                          <span className={`${item.status === "returnable" ? "text-white" : "text-gray-500"}`}>
                            {item.item}
                          </span>
                        </div>
                      )
            ...
            <Card className="bg-neutral-900 border border-neutral-800">
              ...
              <CardContent>
                <div className="space-y-6">
                  <div>
                    <h4 className="font-semibold text-lime-400 mb-2">How long does it take to process a return?</h4>
            ...
            <div className="text-center mt-12">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="lg" asChild className="bg-lime-400 text-black hover:bg-lime-500">
                  <a href="/support">Contact Support</a>
                </Button>
                <Button variant="outline" size="lg" asChild className="border-lime-400 text-lime-400 hover:bg-lime-400 hover:text-black">
