    ...
    <main>
      ...
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl lg:text-5xl font-bold text-lime-400 mb-6">About Zafrine</h1>
          <p className="text-xl text-lime-300 leading-relaxed">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-lime-300">
                <p>
                  Founded in 2000 by master perfumer Isabella Laurent, Luxe Fragrances began as a small atelier in the heart of Paris.
                </p>
                <p>
                  Today, we continue to honor that original vision while embracing innovation and sustainability.
                </p>
                <p>
                  From our signature luxury collection to our fresh everyday scents, fragrance is more than just a product – it's an expression of identity.
                </p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => {
              ...
              return (
                <Card key={index} className="bg-zinc-900 border border-lime-500/30 shadow-lg rounded-2xl text-center">
                  <CardContent className="p-6">
                    <div className="w-12 h-12 bg-black rounded-full flex items-center justify-center mx-auto mb-4">
                      <Icon className="w-6 h-6 text-lime-400" />
                    </div>
                    <h3 className="text-xl font-semibold text-lime-400 mb-2">{value.title}</h3>
                    <p className="text-lime-300">{value.description}</p>
                  </CardContent>
                </Card>
              )
            })}
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-lime-400 mb-4">Meet Our Team</h2>
            <p className="text-lg text-lime-300 max-w-2xl mx-auto">
              Our passionate team of experts brings together decades of experience in perfumery, design, and customer service.
            </p>
          </div>
            ...
            {[
              ...
              <Card key={index} className="bg-zinc-900 border border-lime-500/30 shadow-lg rounded-2xl text-center">
                <CardContent className="p-6">
                  ...
                  />
                  <h3 className="text-xl font-semibold text-lime-400 mb-1">{member.name}</h3>
