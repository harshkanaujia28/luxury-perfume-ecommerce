...
import { useApi } from "@/contexts/api-context"; // useApi from your ApiContext
import { useToast } from "@/hooks/use-toast";
import type { User } from "@/contexts/api-context"; // User type from ApiContext
...
export default function LoginPage() {
  ...
  const { refreshWishlist } = useWishlist(); // agar wishlist bhi same tarah se banaya hai
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({ title: "Login successful", description: `Welcome back, ${user.name || user.role}!` });
            await refreshCart();
