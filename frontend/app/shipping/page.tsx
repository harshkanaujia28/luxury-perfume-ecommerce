    ...
    <main>
      ...
      <section className="luxury-gradient py-40">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-lime-300">Fast, secure, and reliable delivery worldwide</p>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-lime-300">Choose the shipping method that works best for you</p>
          </div>
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div>
                        ...
                        <div className="text-sm text-lime-300">{method.time}</div>
                      </div>
                      <p className="text-lime-300">{method.description}</p>
                    </div>
                  </CardContent>
                </Card>
              );
          ...
          <div className="mb-16">
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-lime-300">We ship to over 100 countries worldwide</p>
            </div>

            <Card className="bg-zinc-900 border border-lime-500/30 shadow-lg rounded-2xl">
              <CardContent className="p-6">
                <div className="overflow-x-auto">
                  <table className="w-full text-lime-300 border-collapse">
                    <thead>
