...
export const products: Product[] = [
  // Men's Perfumes (10 products)
    ...
    images: ["/assets/bottle-2387210_1280.jpg", "/assets/bottle-2387210_1280.jpg"],
    description: "A sophisticated blend of oud and amber.",
    category: { type: "Perfume", gender: "Men", subCategory: "Celebrity" },
 
    inStock: true,
    rating: 4.8,
    reviews: 95,
    features: ["Long-lasting", "Luxurious", "Elegant"],
    specifications: {
  ...
  },
  {
    ...
    price: 99,
    image: "/assets/3.jpeg",
    images: ["/assets/3.jpeg", "/assets/3.jpeg"],
    description: "Deep, mysterious notes of oud and spices.",
    category: { type: "Attar", gender: "Men", subCategory: "Traditional" },
 
    inStock: true,
    rating: 4.7,
    reviews: 120,
    features: ["Oud", "Spicy", "Bold"],
    specifications: {
      skinType: "All skin types",
  ...
  },
  {
    ...
    category: { type: "Perfume", gender: "Men", subCategory: "Traditional" },
  ...
  },
  {
    ...
    category: { type: "Attar", gender: "Men", subCategory: "Party, Dates, Special Occasion" },
  ...
  },
  {
    ...
    category: { type: "Perfume", gender: "Men", subCategory: "Office" },
  ...
  },
  {
    ...
    category: { type: "Attar", gender: "Men", subCategory: "Gym" },
  ...
  },
  {
    ...
    category: { type: "Perfume", gender: "Men", subCategory: "Party, Dates, Special Occasion" },
  ...
  },
  {
    ...
    category: { type: "Attar", gender: "Men", subCategory: "Office" },
  ...
  // Women's Perfumes (10 products)
  {
    ...
    description:
      "A delicate floral bouquet with rose petals and jasmine, perfect for romantic evenings.",
    category: { type: "Perfume", gender: "Women", subCategory: "Gym" },
  ...
  },
  {
    ...
    description:
      "Deep red roses with patchouli and vanilla, perfect for intimate moments.",
    category: { type: "Attar", gender: "Women", subCategory: "Summer" },
  ...
  },
  {
    ...
    description:
      "Creamy vanilla with caramel and tonka bean, a gourmand delight.",
    category: { type: "Perfume", gender: "Women", subCategory: "Office" },
  ...
  },
  {
    ...
    category: { type: "Attar", gender: "Women", subCategory: "Celebrity" },
  ...
  },
  {
    ...
    category: { type: "Perfume", gender: "Women", subCategory: "Party, Dates, Special Occasion" },
  ...
  },
  {
    ...
    category: { type: "Attar", gender: "Women", subCategory: "Winter" },
  ...
  },
  {
    ...
    category: { type: "Attar", gender: "Women", subCategory: "Office" },
  ...
  },
  {
    ...
    description:
      "Mystical moonlight with silver iris and night blooming jasmine.",
    category: { type: "Perfume", gender: "Women", subCategory: "Summer" },
...
// Unisex Perfumes (10 products)
{
  ...
  category: { type: "Perfume", gender: "Women", subCategory: "Winter" },
  inStock: true,
  rating: 4.7,
  reviews: 98,
...
},
{
  ...
  category: { type: "Attar", gender: "Men", subCategory: "Celebrity" },
  inStock: true,
  rating: 4.4,
  reviews: 52,
...
export const categories = [
  ...
  },
  {
    type: "Attar",
    genders: {
      Men: ["Traditional", "Summer", "Gym", "Office", "Winter", "Spiritual"],
      Women: ["Traditional", "Summer", "Gym", "Office", "Winter", "Spiritual"],
    },
  },
];
